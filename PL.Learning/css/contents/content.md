### [CSS 内容](#)
> **介绍** CSS 的 content CSS 属性用于在元素的 `::before` 和 `::after` 伪元素中插入内容。使用 content 属性插入的内容都是匿名的 `可替换元素`。
...
|[counter-increment](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/counter-increment)|	CSS2|	无|	设定当一个selector发生时计数器增加的值|
|[counter-reset](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/counter-reset)|CSS2|无|	将指定selector的计数器复位|
|[counter-set](https://developer.mozilla.org/zh-CN/docs/Web/CSS/counter-set)	 |CSS2|无|将CSS计数器设置为给定值。|
